package com.qa.hybridninja.listeners;
...
import com.qa.ninjahybrid.utilities.NinjaHybrid_ExtentReport;

public class HybridNinja_Listeners implements  ITestListener{
	...
	public void onStart(ITestContext context) {
		try {
			extentReport = NinjaHybrid_ExtentReport.generateNinjaExtentReport();
		} catch (Exception e) {
